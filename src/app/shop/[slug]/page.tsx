...
function ImageZoom({ src, alt }: { src: string; alt: string }) {
  ...
  return (
    <>
      <div
        className="aspect-square bg-[#F7F7F7] flex items-center justify-center cursor-zoom-in overflow-hidden"
...
export default function ShopProduct({ params }: { params: { slug: string } }) {
